...
export const asyncRouter2 = {
    ...
    Page1: {
      path: '/page1',
      component:  () => import(/* webpackChunkName: "page1" */ '../views/test/router/page1.vue')
    },
    Page1_1: {
      path: '/page1_1',
      component: () => import(/* webpackChunkName: "page1" */ '../views/test/router/page1/page1_1.vue'),
    },
    Page2: {
        path: '/page2',
        component:  () => import(/* webpackChunkName: "Page2" */ '../views/test/router/page2.vue')
    },
    Page3: {
        path: '/page3',
        component:  () => import(/* webpackChunkName: "page3" */ '../views/test/router/page3.vue')
    },
    Page4: {
        path: '/page4',
        component:  () => import(/* webpackChunkName: "page4" */ '../views/test/router/page4.vue')
    }
}
